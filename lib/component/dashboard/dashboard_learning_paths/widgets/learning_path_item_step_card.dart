...
class LearningPathItemStepCard extends StatefulWidget {
  final LearningPathStep learningPathStep;
  final double height;
  final double width;
  final double borderRadius;
  const LearningPathItemStepCard(
      {Key? key,
      required this.learningPathStep,
  ...
  @override
  State<LearningPathItemStepCard> createState() =>
      _LearningPathItemStepCardState();
}

class _LearningPathItemStepCardState extends State<LearningPathItemStepCard> {
                ...
                children: [
                  ClipRRect(
                    ...
                    child: CachedNetworkImage(
                      ...
                      width: widget.width,
                      height: widget.height,
                      imageUrl: widget.learningPathStep.thumbnail,
